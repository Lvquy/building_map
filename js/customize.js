...
function choice(cs) {
	...
	if (cs == "P2"){
		...
		bg_image = '<img src="1-2.png" class="img-fluid" >'
	}
	if (cs == "P3"){
		...
		bg_image = '<img src="1-3.png" class="img-fluid" >'
	}
	if (cs == "P4"){
		...
		bg_image = '<img src="1-4.png" class="img-fluid" >'
	}
	if (cs == "P5"){
		...
		bg_image = '<img src="1-5.png" class="img-fluid" >'
	}
	if (cs == "P6"){
		...
		bg_image = '<img src="1-6.png" class="img-fluid" >'
	}
	if (cs == "P7"){
		...
		bg_image = '<img src="1-7.png" class="img-fluid" >'
	}
	if (cs == "P8"){
		...
		bg_image = '<img src="1-8.png" class="img-fluid" >'
	}
	if (cs == "P9"){
		...
		bg_image = '<img src="1-9.png" class="img-fluid" >'
	}
	if (cs == "P10"){
		...
		bg_image = '<img src="1-10.png" class="img-fluid" >'
	}
	if (cs == "P11"){
		...
		bg_image = '<img src="1-11.png" class="img-fluid" >'
	}
	if (cs == "P12"){
		...
		bg_image = '<img src="1-12.png" class="img-fluid" >'
	}
	if (cs == "P13"){
		...
		bg_image = '<img src="1-13.png" class="img-fluid" >'
	}
	if (cs == "P14"){
		...
		bg_image = '<img src="1-14.png" class="img-fluid">'
	}
	if (cs == "P15"){
		...
		bg_image = '<img src="1-15.png" class="img-fluid" >'
	}
	if (cs == "P16"){
		...
		bg_image = '<img src="1-16.png" class="img-fluid" >'
	}
	if (cs == "P17"){
		...
		bg_image = '<img src="1-17.png" class="img-fluid" >'
	}
	if (cs == "P18"){
		...
		bg_image = '<img src="1-18.png" class="img-fluid" >'
	}
